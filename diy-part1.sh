...
rm -rf ./openwrt-luci/trunk/themes/luci-theme-bootstrap && git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/lean/luci-theme-argon  #新的argon主题
